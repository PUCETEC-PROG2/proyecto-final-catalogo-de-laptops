...
from laptops.forms import ClientForm, ProductForm, ProductStockForm, SaleForm
...
def edit_product(request, category_name, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('laptops:category_view', category_name=category_name)
    else:
